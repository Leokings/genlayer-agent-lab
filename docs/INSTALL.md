...
```sh
uv pip install --python .lab-env/bin/python /path/to/genlayer_agent_lab-0.1.0a7-py3-none-any.whl
...
```powershell
uv pip install --python .lab-env/Scripts/python.exe C:/path/to/genlayer_agent_lab-0.1.0a7-py3-none-any.whl
