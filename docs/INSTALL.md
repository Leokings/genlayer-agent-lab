...
On a desktop, setup opens the browser automatically. On a VPS, use **Open my dashboard** on the [public setup page](https://genlayer-agent-lab-setup.vercel.app/#open-dashboard). It guides you through your existing Termius connection, one step at a time. An agent on the VPS cannot operate Termius on your laptop.
