...
| Publication | Local wheel/source package, checksum bundle preparation and installed-artifact CI matrix | Choose a project repository, run remote CI, publish a marked prerelease and complete two external installation trials |
...
| September 15–16: recovery, upgrades, documentation, external onboarding | Local recovery/upgrade verification and release preparation in progress/completed as recorded; remote CI, external trials and publication remain open |
